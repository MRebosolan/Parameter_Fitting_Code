...
print(f'Norton constants: {popt}')
popt2, cov2 = curve_fit(Garofalo, predictor_array, strain_rate_array, p0=garofalop0, bounds=garofalobounds)   #PREDICTS Q, NOT Q/R
print(f'Garofalo constants: {popt2}')

ladida = np.array([5, 125+273.15]).reshape((-1, 1))
whoop = Garofalo(ladida, *popt2)
scoop = Norton(ladida, *popt)
print(f'The Norton creep strain rate at T: 125C and sigma: 5 Mpa is {scoop} 1/sec')
print(f'The Garofalo creep strain rate at T: 125C and sigma: 5 Mpa is {whoop} 1/sec')